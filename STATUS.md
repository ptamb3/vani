...
**Last updated:** 2026-06-01 (closures #501/#502 — **`f64_hash_pair(a, b: f64) -> u64`** and **`f64_hash_triple(a, b, c: f64) -> u64`** f64-tuple hashing sugar. Mirror of #499/#500 with `intent_hash_f64` instead of `intent_hash_i64` element hashing. Companion to the i64 pair/triple — covers the float-keyed tuple case (spatial coords, normalized weights, etc.). Both backends byte-identical: `f64_hash_pair(1.5, 2.5) == -4790552436714371306_i64`, `f64_hash_triple(1.5, 2.5, 3.5) == 7700734681350794597_i64`, each equal to manual chained `hash_combine`+`hash_f64`. 1 new lib test. 1515 lib + 54 parity green.)
