...
**Last updated:** 2026-06-01 (closures #503/#504 — **`str_hash_pair(a, b: Str) -> u64`** and **`str_hash_triple(a, b, c: Str) -> u64`** Str-tuple hashing sugar. Mirror of #499/#500 with `intent_hash_str` for element hashing. Completes the tuple-key surface (i64/f64/Str × pair/triple, 6 forms total). Both backends byte-identical: `str_hash_pair("foo", "bar") == -2411426634940399557_i64`, `str_hash_triple("foo", "bar", "baz") == -6430283472446221474_i64`, each equal to manual chained `hash_combine`+`hash_str`. 1 new lib test. 1516 lib + 54 parity green.)
