...
**Last updated:** 2026-05-31 (closure #458 — **`i64_min_3(a, b, c) -> i64`** three-argument min. Two-arg `i64_min` (#411) chained with itself; this is the explicit variadic-like sugar. C: inline chained ternary `__ab = a < b ? a : b; __ab < c ? __ab : c`. LLVM: two `icmp slt` + two `select` instructions in sequence. Both backends byte-identical: `min3(5, 3, 7) = 3`, `min3(7, 3, 5) = 3`, `min3(3, 5, 7) = 3`, `min3(-5, 0, 5) = -5`, `min3(0, 0, 0) = 0`, `min3(MAX, 0, MIN) = MIN`. 1 new lib test. 1482 lib + 54 parity green. Closure #457 (whitespace-count) shipped immediately before.)
