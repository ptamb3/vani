...
**Last updated:** 2026-06-01 (closure #498 — **`hash_combine_4(a, b, c, d: u64) -> u64`** 4-arg hash combiner. Left-fold of the existing FNV-tuned mixer: `hash_combine(hash_combine(hash_combine(a, b), c), d)`. Companion to #497 `hash_combine_3` — together they cover the tuple-arity prefix (1–4) most user code needs. Both backends byte-identical: with `hash_i64(1..4)` the result interprets as i64 `7085637984461672644`, equal to chaining #497 + 2-arg #313. C: inline left-fold of `intent_hash_combine`. LLVM: three sequential `@intent_hash_combine` calls. 1 new lib test. 1513 lib + 54 parity green.)
