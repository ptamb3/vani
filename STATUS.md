...
**Last updated:** 2026-05-31 (closure #414 — **`asin / acos / atan`** + **`sinh / cosh / tanh`** inverse + hyperbolic trig. Six libm-backed f64 → f64 helpers complete the standard trig surface alongside the previously-shipped `sin / cos / tan / atan2`. C: routed through the same `name(({}))` template as `sin / cos / tan`. LLVM: extern declarations `declare double @asin(double)` etc. in the preamble and the existing single-arg libm match arm extended to cover all six new names. Both backends byte-identical: `asin(0.5) = 0.523599` (π/6), `asin(1.0) = 1.5708` (π/2), `acos(1.0) = 0`, `atan(1.0) = 0.785398` (π/4), `sinh(0) = 0`, `cosh(0) = 1`, `tanh(0) = 0`, `tanh(1) = 0.761594`. 2 new lib tests (typecheck + libm declare/call emission across all six). 1417 lib + 54 parity green. Closure #413 (hypot + angle conversion) shipped immediately before.)
