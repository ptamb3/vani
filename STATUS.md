...
**Last updated:** 2026-05-31 (closure #423 — **`i64_log10_ceil(n) -> i64`** base-10 ceiling logarithm. Returns the smallest k such that 10^k ≥ n; returns 0 for n ≤ 1. Companion to closure #422 (`log10_floor`). Note that `log10_ceil` and `log10_floor` differ exactly at non-power-of-10 values: `log10_ceil(100) = 2`, `log10_ceil(101) = 3`, while `log10_floor(100) = log10_floor(101) = 2`. C: inline GNU statement-expression — start at `m = 1, c = 0` and `while m < n: m *= 10; c += 1`. LLVM: emits a shared `@intent_i64_log10_ceil(i64) -> i64` helper with the same alloca-per-state + br-back-to-head loop shape. Both backends byte-identical: `log10_ceil(0) = 0`, `log10_ceil(1) = 0`, `log10_ceil(2) = 1`, `log10_ceil(9) = 1`, `log10_ceil(10) = 1`, `log10_ceil(11) = 2`, `log10_ceil(99) = 2`, `log10_ceil(100) = 2`, `log10_ceil(101) = 3`, `log10_ceil(1000) = 3`. 2 new lib tests. 1434 lib + 54 parity green. Closure #422 (log10_floor) shipped immediately before.)
