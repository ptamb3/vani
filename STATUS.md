...
**Last updated:** 2026-05-31 (closure #466 — **`str_first_byte(s) -> Option<i64>`** first byte of s as Option (None for empty). Auto-triggers Option<i64> bundle via walker. Both backends byte-identical: `fb('Hello') = Some(72)`, `fb('A') = Some(65)`, `fb('') = None`. 1 new lib test. 1490 lib + 54 parity green.)
