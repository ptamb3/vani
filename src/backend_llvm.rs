...
pub fn emit_llvm(program: &TypedProgram) -> String {
    ...
    // HashMap<i64, i64> (closure #305 + tombstones in #343):
    //   0: keys (i64*)
    //   1: values (i64*)
    //   2: occ (i8*) — 0=empty, 1=occupied, 2=tombstone
    //   3: len (i64)
    //   4: capacity (i64)
    //   5: tombstones (i64) — slot count in state 2.
    out.push_str("%intent_hashmap_i64_i64 = type { i64*, i64*, i8*, i64, i64, i64 }\n");
    ...
    // Bst<i64> helpers (closure #328, Level 4 #3).
    if crate::backend_c::program_uses_i64_bst(program) {
        let has_option_i64 = LLVM_ENUM_PAYLOAD_REGISTRY.with(|r| {
            r.borrow().contains_key("Option__i64")
        });
    ...
    match &expr.kind {
        ...
        TypedExprKind::Call { name, args, .. } => {
            ...
            if name == "bst_new" {
                let dest = ctx.fresh_tmp();
                out.push_str(&format!(
                    "  {} = call %intent_bst_i64 @intent_bst_i64_new()\n",
                    dest
                ));
                return dest;
            }
            if name == "bst_insert" {
                ...
                let dest = ctx.fresh_tmp();
                out.push_str(&format!(
                    "  {} = call i1 @intent_bst_i64_insert(%intent_bst_i64* {}, i64 {})\n",
                    dest, b, x
                ));
                return dest;
            }
            if name == "bst_contains" {
                let b = emit_expr(&args[0], ctx, out);
                let x = emit_expr(&args[1], ctx, out);
                let dest = ctx.fresh_tmp();
                out.push_str(&format!(
                    "  {} = call i1 @intent_bst_i64_contains(%intent_bst_i64* {}, i64 {})\n",
                    dest, b, x
                ));
                return dest;
            }
            if name == "bst_remove" {
                ...
                let dest = ctx.fresh_tmp();
                out.push_str(&format!(
                    "  {} = call i1 @intent_bst_i64_remove(%intent_bst_i64* {}, i64 {})\n",
                    dest, b, x
                ));
                return dest;
            }
            ...
            if name == "bst_min" {
                ...
                let dest = ctx.fresh_tmp();
                out.push_str(&format!(
                    "  {} = call %Enum_Option__i64 @intent_bst_i64_min(%intent_bst_i64* {})\n",
                    dest, b
                ));
                return dest;
            }
...
/// runtime helpers. Parallel keys + values + occ arrays with
...
fn emit_intent_hashmap_i64_i64_helpers_llvm(out: &mut String, has_option_i64: bool) {
    out.push_str(
        "define %intent_hashmap_i64_i64 @intent_hashmap_i64_i64_new() {\n\
         \x20 %r0 = insertvalue %intent_hashmap_i64_i64 undef, i64* null, 0\n\
         \x20 %r1 = insertvalue %intent_hashmap_i64_i64 %r0, i64* null, 1\n\
         \x20 %r2 = insertvalue %intent_hashmap_i64_i64 %r1, i8* null, 2\n\
         \x20 %r3 = insertvalue %intent_hashmap_i64_i64 %r2, i64 0, 3\n\
         \x20 %r4 = insertvalue %intent_hashmap_i64_i64 %r3, i64 0, 4\n\
         ...
         \x20 %opp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 2\n\
         \x20 %keys = load i64*, i64** %kpp\n\
         ...
         \x20 %lp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 3\n\
         \x20 %cp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 4\n\
         \x20 %tp_drop_hm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 5\n\
         \x20 store i64 0, i64* %lp\n\
         \x20 store i64 0, i64* %cp\n\
         ...
         \x20 %h = call i64 @intent_hashmap_i64_i64__hash_key(i64 %k)\n\
         ...
         ir_update:\n\
         \x20 %vcell = getelementptr i64, i64* %vals, i64 %i\n\
         \x20 store i64 %v, i64* %vcell\n\
         \x20 ret void\n\
         ir_next:\n\
         \x20 %i_p1 = add i64 %i, 1\n\
         ...
         \x20 %vcell2 = getelementptr i64, i64* %vals, i64 %i\n\
         \x20 store i64 %k, i64* %kcell2\n\
         \x20 store i64 %v, i64* %vcell2\n\
         ...
         define internal void @intent_hashmap_i64_i64__grow(%intent_hashmap_i64_i64* %m) {\n\
         \x20 %kpp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 0\n\
         \x20 %vpp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 1\n\
         \x20 %opp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 2\n\
         \x20 %lp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 3\n\
         ...
         \x20 %nk_i8 = call i8* @malloc(i64 %nb)\n\
         \x20 %nk = bitcast i8* %nk_i8 to i64*\n\
         \x20 %nv_i8 = call i8* @malloc(i64 %nb)\n\
         ...
         \x20 store i64 0, i64* %lp\n\
         \x20 store i64 %new_cap, i64* %cp\n\
         \x20 ; Closure #343: rehash clears all tombstones.\n\
         \x20 %tp_grow_hm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 5\n\
         ...
         \x20 %kv = load i64, i64* %kcell\n\
         \x20 %vcell = getelementptr i64, i64* %old_vals, i64 %i\n\
         \x20 %vv = load i64, i64* %vcell\n\
         \x20 call void @intent_hashmap_i64_i64__insert_raw(%intent_hashmap_i64_i64* %m, i64 %kv, i64 %vv)\n\
         \x20 br label %g_next\n\
         g_next:\n\
         \x20 %i_n = add i64 %i, 1\n\
         \x20 store i64 %i_n, i64* %i_p\n\
         ...
         \x20 br label %g_v\n\
         g_v:\n\
         \x20 %ov_null = icmp eq i64* %old_vals, null\n\
         ...
         define i1 @intent_hashmap_i64_i64_contains_key(%intent_hashmap_i64_i64* %m, i64 %k) {\n\
         \x20 %cp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 4\n\
         \x20 %cap = load i64, i64* %cp\n\
         ...
         define i64 @intent_hashmap_i64_i64_len(%intent_hashmap_i64_i64* %m) {\n\
         \x20 %lp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 3\n\
         \x20 %len = load i64, i64* %lp\n\
         \x20 ret i64 %len\n\
         }\n",
    ...
    if has_option_i64 {
        out.push_str(
            "define %Enum_Option__i64 @intent_hashmap_i64_i64_get(%intent_hashmap_i64_i64* %m, i64 %k) {\n\
             \x20 %cp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 4\n\
             \x20 %cap = load i64, i64* %cp\n\
             \x20 %is_zero = icmp eq i64 %cap, 0\n\
             ...
             \x20 %r2 = insertvalue %Enum_Option__i64 %r1, i64 %vv, 1\n\
             ...
             define %Enum_Option__i64 @intent_hashmap_i64_i64_insert(%intent_hashmap_i64_i64* %m, i64 %k, i64 %v) {\n\
             \x20 %cp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 4\n\
             \x20 %lp = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 3\n\
             \x20 %tp_ins_hm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 5\n\
             \x20 %cap = load i64, i64* %cp\n\
             \x20 %len = load i64, i64* %lp\n\
             \x20 %tomb = load i64, i64* %tp_ins_hm\n\
             \x20 %cap_zero = icmp eq i64 %cap, 0\n\
             \x20 ; Closure #343: load includes both occupied (len) and tombstones.\n\
             ...
             ins_grow:\n\
             \x20 call void @intent_hashmap_i64_i64__grow(%intent_hashmap_i64_i64* %m)\n\
             ...
             \x20 br label %ins_loop\n\
             ins_update:\n\
             \x20 %vcell_u = getelementptr i64, i64* %vals, i64 %i\n\
             \x20 %old_v = load i64, i64* %vcell_u\n\
             \x20 store i64 %v, i64* %vcell_u\n\
             \x20 %r1 = insertvalue %Enum_Option__i64 undef, i32 0, 0\n\
             \x20 %r2 = insertvalue %Enum_Option__i64 %r1, i64 %old_v, 1\n\
             \x20 ret %Enum_Option__i64 %r2\n\
             ins_place:\n\
             \x20 ; Empty slot found and key wasn't already present.\n\
             ...
             \x20 %tv = getelementptr i64, i64* %vals, i64 %ft_f\n\
             \x20 store i64 %v, i64* %tv\n\
             ...
             ; Closure #343: hashmap_remove. Returns Some(prev_value) if\n\
             ; the key was present (marks slot tombstone, --len, ++tomb)\n\
             ; or None if absent.\n\
             define %Enum_Option__i64 @intent_hashmap_i64_i64_remove(%intent_hashmap_i64_i64* %m, i64 %k) {\n\
             \x20 %cp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 4\n\
             \x20 %cap_rm = load i64, i64* %cp_rm\n\
             \x20 %is_zero_rm = icmp eq i64 %cap_rm, 0\n\
             \x20 br i1 %is_zero_rm, label %hmr_none, label %hmr_probe\n\
             hmr_probe:\n\
             \x20 %kpp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 0\n\
             \x20 %vpp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 1\n\
             \x20 %opp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 2\n\
             \x20 %lp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 3\n\
             \x20 %tp_rm = getelementptr %intent_hashmap_i64_i64, %intent_hashmap_i64_i64* %m, i32 0, i32 5\n\
             \x20 %mask_rm = sub i64 %cap_rm, 1\n\
             \x20 %keys_rm = load i64*, i64** %kpp_rm\n\
             \x20 %vals_rm = load i64*, i64** %vpp_rm\n\
             \x20 %occ_rm = load i8*, i8** %opp_rm\n\
             \x20 %h_rm = call i64 @intent_hashmap_i64_i64__hash_key(i64 %k)\n\
             ...
             \x20 br label %hmr_loop\n\
             hmr_yes:\n\
             \x20 %vcell_rm = getelementptr i64, i64* %vals_rm, i64 %i_rm\n\
             \x20 %prev_v = load i64, i64* %vcell_rm\n\
             ...
             \x20 %r1_rm = insertvalue %Enum_Option__i64 undef, i32 0, 0\n\
             \x20 %r2_rm = insertvalue %Enum_Option__i64 %r1_rm, i64 %prev_v, 1\n\
             \x20 ret %Enum_Option__i64 %r2_rm\n\
             hmr_none:\n\
             \x20 %nn1_rm = insertvalue %Enum_Option__i64 undef, i32 1, 0\n\
             \x20 %nn2_rm = insertvalue %Enum_Option__i64 %nn1_rm, i64 0, 1\n\
             \x20 ret %Enum_Option__i64 %nn2_rm\n\
             }\n\n",
        );
    }
}
...
fn emit_intent_bst_i64_helpers_llvm(out: &mut String, has_option_i64: bool) {
    out.push_str(
        "define %intent_bst_i64 @intent_bst_i64_new() {\n\
         \x20 %r0 = insertvalue %intent_bst_i64 undef, i64* null, 0\n\
         \x20 %r1 = insertvalue %intent_bst_i64 %r0, i32* null, 1\n\
         \x20 %r2 = insertvalue %intent_bst_i64 %r1, i32* null, 2\n\
         ...
         \x20 br label %d_left\n\
         d_left:\n\
         \x20 %l_null = icmp eq i32* %lefts, null\n\
         \x20 br i1 %l_null, label %d_right, label %d_fl\n\
         d_fl:\n\
         \x20 %l_i8 = bitcast i32* %lefts to i8*\n\
         \x20 call void @free(i8* %l_i8)\n\
         ...
         \x20 store i64 -1, i64* %rtp\n\
         \x20 store i64 0, i64* %lp\n\
         \x20 store i64 0, i64* %cp\n\
         \x20 ret void\n\
         }\n\
         define void @intent_bst_i64_grow(%intent_bst_i64* %b) {\n\
         \x20 %kpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 0\n\
         \x20 %lpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 1\n\
         \x20 %rpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 2\n\
         \x20 %hpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 6\n\
         ...
         \x20 %cap_mul = mul i64 %cap_old, 2\n\
         \x20 %cap_new = select i1 %cap_zero, i64 8, i64 %cap_mul\n\
         \x20 %keys_old = load i64*, i64** %kpp\n\
         \x20 %keys_old_i8 = bitcast i64* %keys_old to i8*\n\
         \x20 %k_bytes = mul i64 %cap_new, 8\n\
         \x20 %keys_new_i8 = call i8* @realloc(i8* %keys_old_i8, i64 %k_bytes)\n\
         \x20 %keys_new = bitcast i8* %keys_new_i8 to i64*\n\
         \x20 store i64* %keys_new, i64** %kpp\n\
         \x20 %lefts_old = load i32*, i32** %lpp\n\
         \x20 %lefts_old_i8 = bitcast i32* %lefts_old to i8*\n\
         \x20 %lr_bytes = mul i64 %cap_new, 4\n\
         \x20 %lefts_new_i8 = call i8* @realloc(i8* %lefts_old_i8, i64 %lr_bytes)\n\
         \x20 %lefts_new = bitcast i8* %lefts_new_i8 to i32*\n\
         \x20 store i32* %lefts_new, i32** %lpp\n\
         \x20 %rights_old = load i32*, i32** %rpp\n\
         \x20 %rights_old_i8 = bitcast i32* %rights_old to i8*\n\
         ...
         \x20 br label %co_loop\n\
         co_loop:\n\
         \x20 %cur = load i64, i64* %cur_p\n\
         \x20 %is_done = icmp eq i64 %cur, -1\n\
         \x20 br i1 %is_done, label %co_false, label %co_test\n\
         co_test:\n\
         \x20 %keys_c = load i64*, i64** %kpp\n\
         \x20 %k_slot = getelementptr i64, i64* %keys_c, i64 %cur\n\
         \x20 %k = load i64, i64* %k_slot\n\
         \x20 %eq = icmp eq i64 %x, %k\n\
         \x20 br i1 %eq, label %co_true, label %co_descend\n\
         co_descend:\n\
         \x20 %lt = icmp slt i64 %x, %k\n\
         \x20 br i1 %lt, label %co_left, label %co_right\n\
         co_left:\n\
         \x20 %lefts_c = load i32*, i32** %lpp\n\
         \x20 %l_slot = getelementptr i32, i32* %lefts_c, i64 %cur\n\
         \x20 %l32 = load i32, i32* %l_slot\n\
         \x20 %l64 = sext i32 %l32 to i64\n\
         \x20 store i64 %l64, i64* %cur_p\n\
         \x20 br label %co_loop\n\
         co_right:\n\
         \x20 %rights_c = load i32*, i32** %rpp\n\
         \x20 %r_slot = getelementptr i32, i32* %rights_c, i64 %cur\n\
         ...
         define i64 @intent_bst_i64_len(%intent_bst_i64* %b) {\n\
         \x20 %lp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 4\n\
         \x20 %v = load i64, i64* %lp\n\
         \x20 ret i64 %v\n\
         }\n\
    ...
    if has_option_i64 {
        out.push_str(
            "define %Enum_Option__i64 @intent_bst_i64_min(%intent_bst_i64* %b) {\n\
             \x20 %kpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 0\n\
             \x20 %lpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 1\n\
             \x20 %rtp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 3\n\
             \x20 %root = load i64, i64* %rtp\n\
             \x20 %is_empty = icmp eq i64 %root, -1\n\
             \x20 br i1 %is_empty, label %mn_none, label %mn_walk\n\
             mn_walk:\n\
             \x20 %cur_p = alloca i64\n\
             \x20 store i64 %root, i64* %cur_p\n\
             \x20 br label %mn_loop\n\
             mn_loop:\n\
             \x20 %cur = load i64, i64* %cur_p\n\
             \x20 %lefts_m = load i32*, i32** %lpp\n\
             \x20 %slot = getelementptr i32, i32* %lefts_m, i64 %cur\n\
             \x20 %l32 = load i32, i32* %slot\n\
             \x20 %is_done = icmp eq i32 %l32, -1\n\
             \x20 br i1 %is_done, label %mn_some, label %mn_step\n\
             mn_step:\n\
             \x20 %l64 = sext i32 %l32 to i64\n\
             \x20 store i64 %l64, i64* %cur_p\n\
             \x20 br label %mn_loop\n\
             mn_some:\n\
             \x20 %keys_m = load i64*, i64** %kpp\n\
             \x20 %k_slot = getelementptr i64, i64* %keys_m, i64 %cur\n\
             \x20 %k = load i64, i64* %k_slot\n\
             \x20 %s0 = insertvalue %Enum_Option__i64 undef, i32 0, 0\n\
             ...
             define %Enum_Option__i64 @intent_bst_i64_max(%intent_bst_i64* %b) {\n\
             \x20 %kpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 0\n\
             \x20 %rpp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 2\n\
             \x20 %rtp = getelementptr %intent_bst_i64, %intent_bst_i64* %b, i32 0, i32 3\n\
             \x20 %root = load i64, i64* %rtp\n\
             \x20 %is_empty = icmp eq i64 %root, -1\n\
             \x20 br i1 %is_empty, label %mx_none, label %mx_walk\n\
             mx_walk:\n\
             \x20 %cur_p = alloca i64\n\
             \x20 store i64 %root, i64* %cur_p\n\
             \x20 br label %mx_loop\n\
             mx_loop:\n\
             \x20 %cur = load i64, i64* %cur_p\n\
             \x20 %rights_m = load i32*, i32** %rpp\n\
             \x20 %slot = getelementptr i32, i32* %rights_m, i64 %cur\n\
             \x20 %r32 = load i32, i32* %slot\n\
             \x20 %is_done = icmp eq i32 %r32, -1\n\
             \x20 br i1 %is_done, label %mx_some, label %mx_step\n\
             mx_step:\n\
             \x20 %r64 = sext i32 %r32 to i64\n\
             \x20 store i64 %r64, i64* %cur_p\n\
             \x20 br label %mx_loop\n\
...
fn emit_intent_graph_helpers_llvm(out: &mut String, has_option_i64: bool, emit_vec_dep: bool) {
    out.push_str(
        "define %intent_graph @intent_graph_new(i64 %n_in) {\n\
         ...
         ic_fas:\n\
         \x20 %as_i8 = bitcast i32* %as_v to i8*\n\
         \x20 call void @free(i8* %as_i8)\n\
         \x20 br label %ic_acd\n\
         ic_acd:\n\
         \x20 %acd_null = icmp eq i32* %acd_v, null\n\
         \x20 br i1 %acd_null, label %ic_acw, label %ic_facd\n\
         ic_facd:\n\
         \x20 %acd_i8 = bitcast i32* %acd_v to i8*\n\
         \x20 call void @free(i8* %acd_i8)\n\
         \x20 br label %ic_acw\n\
         ic_acw:\n\
         ...
         ; adj_start[i] = offset into adj_csr_dst where node i's\n\
         ; outgoing neighbors begin; adj_start[num_nodes] = total\n\
         ; edges actually placed (out-of-range edges skipped).\n\
         define void @intent_graph_build_csr_if_needed(%intent_graph* %g) {\n\
         \x20 %asp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 6\n\
         \x20 %as_cur = load i32*, i32** %asp\n\
         \x20 %has_csr = icmp ne i32* %as_cur, null\n\
         \x20 br i1 %has_csr, label %bc_done, label %bc_check_nn\n\
         bc_check_nn:\n\
         \x20 %nnp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 0\n\
         \x20 %nn = load i64, i64* %nnp\n\
         \x20 %nn_le_zero = icmp sle i64 %nn, 0\n\
         \x20 br i1 %nn_le_zero, label %bc_done, label %bc_alloc\n\
         bc_alloc:\n\
         \x20 %nn1 = add i64 %nn, 1\n\
         \x20 %as_bytes = mul i64 %nn1, 4\n\
         \x20 %as_new_i8 = call i8* @malloc(i64 %as_bytes)\n\
         \x20 %as_new = bitcast i8* %as_new_i8 to i32*\n\
         \x20 store i32* %as_new, i32** %asp\n\
         \x20 ; Zero adj_start[0..=nn].\n\
         \x20 %i0_p = alloca i64\n\
         \x20 store i64 0, i64* %i0_p\n\
         \x20 br label %bc_zero_loop\n\
         bc_zero_loop:\n\
         \x20 %i0 = load i64, i64* %i0_p\n\
         \x20 %i0_done = icmp sgt i64 %i0, %nn\n\
         \x20 br i1 %i0_done, label %bc_count_init, label %bc_zero_body\n\
         bc_zero_body:\n\
         \x20 %as_slot0 = getelementptr i32, i32* %as_new, i64 %i0\n\
         \x20 store i32 0, i32* %as_slot0\n\
         \x20 %i0_inc = add i64 %i0, 1\n\
         \x20 store i64 %i0_inc, i64* %i0_p\n\
         \x20 br label %bc_zero_loop\n\
         bc_count_init:\n\
         ...
         \x20 %src_arr_bc = load i32*, i32** %spp\n\
         \x20 %dst_arr_bc = load i32*, i32** %dpp\n\
         \x20 %w_arr_bc = load i64*, i64** %wpp\n\
         \x20 %ec_p = alloca i64\n\
         \x20 store i64 0, i64* %ec_p\n\
         \x20 br label %bc_count_loop\n\
         bc_count_loop:\n\
         \x20 %ec = load i64, i64* %ec_p\n\
         \x20 %ec_done = icmp sge i64 %ec, %ne\n\
         \x20 br i1 %ec_done, label %bc_prefix_init, label %bc_count_body\n\
         bc_count_body:\n\
         \x20 %src_slot_bc = getelementptr i32, i32* %src_arr_bc, i64 %ec\n\
         \x20 %s32_bc = load i32, i32* %src_slot_bc\n\
         \x20 %s64_bc = sext i32 %s32_bc to i64\n\
         \x20 %s_lo_bc = icmp slt i64 %s64_bc, 0\n\
         \x20 %s_hi_bc = icmp sge i64 %s64_bc, %nn\n\
         \x20 %s_bad_bc = or i1 %s_lo_bc, %s_hi_bc\n\
         \x20 br i1 %s_bad_bc, label %bc_count_next, label %bc_count_incr\n\
         bc_count_incr:\n\
         \x20 %s_p1 = add i64 %s64_bc, 1\n\
         \x20 %as_count_slot = getelementptr i32, i32* %as_new, i64 %s_p1\n\
         \x20 %as_count_v = load i32, i32* %as_count_slot\n\
         \x20 %as_count_inc = add i32 %as_count_v, 1\n\
         \x20 store i32 %as_count_inc, i32* %as_count_slot\n\
         \x20 br label %bc_count_next\n\
         bc_count_next:\n\
         \x20 %ec_inc = add i64 %ec, 1\n\
         \x20 store i64 %ec_inc, i64* %ec_p\n\
         \x20 br label %bc_count_loop\n\
         bc_prefix_init:\n\
         \x20 ; Prefix sum: adj_start[i] += adj_start[i-1].\n\
         \x20 %pi_p = alloca i64\n\
         \x20 store i64 1, i64* %pi_p\n\
         \x20 br label %bc_prefix_loop\n\
         bc_prefix_loop:\n\
         \x20 %pi = load i64, i64* %pi_p\n\
         \x20 %pi_done = icmp sgt i64 %pi, %nn\n\
         \x20 br i1 %pi_done, label %bc_alloc_dst, label %bc_prefix_body\n\
         bc_prefix_body:\n\
         \x20 %pi_m1 = sub i64 %pi, 1\n\
         \x20 %prev_slot = getelementptr i32, i32* %as_new, i64 %pi_m1\n\
         \x20 %prev_v = load i32, i32* %prev_slot\n\
         \x20 %cur_slot = getelementptr i32, i32* %as_new, i64 %pi\n\
         \x20 %cur_v = load i32, i32* %cur_slot\n\
         \x20 %sum_p = add i32 %cur_v, %prev_v\n\
         \x20 store i32 %sum_p, i32* %cur_slot\n\
         \x20 %pi_inc = add i64 %pi, 1\n\
         \x20 store i64 %pi_inc, i64* %pi_p\n\
         \x20 br label %bc_prefix_loop\n\
         bc_alloc_dst:\n\
         \x20 %total_slot = getelementptr i32, i32* %as_new, i64 %nn\n\
         \x20 %total_i32 = load i32, i32* %total_slot\n\
         \x20 %total_i64 = sext i32 %total_i32 to i64\n\
         \x20 %has_edges = icmp sgt i64 %total_i64, 0\n\
         \x20 br i1 %has_edges, label %bc_alloc_edge_bufs, label %bc_cursor_init\n\
         bc_alloc_edge_bufs:\n\
         \x20 %acdp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 7\n\
         \x20 %acwp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 8\n\
         \x20 %acd_bytes = mul i64 %total_i64, 4\n\
         \x20 %acd_i8 = call i8* @malloc(i64 %acd_bytes)\n\
         \x20 %acd_new = bitcast i8* %acd_i8 to i32*\n\
         \x20 store i32* %acd_new, i32** %acdp\n\
         \x20 %acw_bytes = mul i64 %total_i64, 8\n\
         \x20 %acw_i8 = call i8* @malloc(i64 %acw_bytes)\n\
         \x20 %acw_new = bitcast i8* %acw_i8 to i64*\n\
         \x20 store i64* %acw_new, i64** %acwp\n\
         \x20 br label %bc_cursor_init\n\
         bc_cursor_init:\n\
         \x20 ; Per-source cursor[i] = adj_start[i] initially.\n\
         \x20 %cur_bytes = mul i64 %nn, 4\n\
         \x20 %cur_i8 = call i8* @malloc(i64 %cur_bytes)\n\
         \x20 %cur_arr = bitcast i8* %cur_i8 to i32*\n\
         \x20 %ci_p = alloca i64\n\
         \x20 store i64 0, i64* %ci_p\n\
         \x20 br label %bc_cursor_init_loop\n\
         bc_cursor_init_loop:\n\
         \x20 %ci = load i64, i64* %ci_p\n\
         \x20 %ci_done = icmp sge i64 %ci, %nn\n\
         \x20 br i1 %ci_done, label %bc_scatter_init, label %bc_cursor_init_body\n\
         bc_cursor_init_body:\n\
         \x20 %as_ci_slot = getelementptr i32, i32* %as_new, i64 %ci\n\
         \x20 %as_ci_v = load i32, i32* %as_ci_slot\n\
         \x20 %cur_ci_slot = getelementptr i32, i32* %cur_arr, i64 %ci\n\
         \x20 store i32 %as_ci_v, i32* %cur_ci_slot\n\
         \x20 %ci_inc = add i64 %ci, 1\n\
         \x20 store i64 %ci_inc, i64* %ci_p\n\
         \x20 br label %bc_cursor_init_loop\n\
         bc_scatter_init:\n\
         \x20 %sp_e = alloca i64\n\
         \x20 store i64 0, i64* %sp_e\n\
         \x20 br label %bc_scatter_loop\n\
         bc_scatter_loop:\n\
         \x20 %ce = load i64, i64* %sp_e\n\
         \x20 %ce_done = icmp sge i64 %ce, %ne\n\
         \x20 br i1 %ce_done, label %bc_finish, label %bc_scatter_body\n\
         bc_scatter_body:\n\
         \x20 %src_arr_sc = load i32*, i32** %spp\n\
         \x20 %src_slot_sc = getelementptr i32, i32* %src_arr_sc, i64 %ce\n\
         \x20 %s32_sc = load i32, i32* %src_slot_sc\n\
         \x20 %s64_sc = sext i32 %s32_sc to i64\n\
         \x20 %s_lo_sc = icmp slt i64 %s64_sc, 0\n\
         \x20 %s_hi_sc = icmp sge i64 %s64_sc, %nn\n\
         \x20 %s_bad_sc = or i1 %s_lo_sc, %s_hi_sc\n\
         \x20 br i1 %s_bad_sc, label %bc_scatter_next, label %bc_scatter_place\n\
         bc_scatter_place:\n\
         \x20 %cur_s_slot = getelementptr i32, i32* %cur_arr, i64 %s64_sc\n\
         \x20 %pos_i32 = load i32, i32* %cur_s_slot\n\
         \x20 %pos_i64 = sext i32 %pos_i32 to i64\n\
         \x20 %pos_inc = add i32 %pos_i32, 1\n\
         \x20 store i32 %pos_inc, i32* %cur_s_slot\n\
         \x20 %dst_arr_sc = load i32*, i32** %dpp\n\
         \x20 %w_arr_sc = load i64*, i64** %wpp\n\
         \x20 %dst_sc_slot = getelementptr i32, i32* %dst_arr_sc, i64 %ce\n\
         \x20 %d32_sc = load i32, i32* %dst_sc_slot\n\
         \x20 %w_sc_slot = getelementptr i64, i64* %w_arr_sc, i64 %ce\n\
         \x20 %w_sc_v = load i64, i64* %w_sc_slot\n\
         \x20 %acdp2 = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 7\n\
         \x20 %acwp2 = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 8\n\
         \x20 %acd_arr = load i32*, i32** %acdp2\n\
         \x20 %acw_arr = load i64*, i64** %acwp2\n\
         \x20 %acd_pos_slot = getelementptr i32, i32* %acd_arr, i64 %pos_i64\n\
         \x20 store i32 %d32_sc, i32* %acd_pos_slot\n\
         \x20 %acw_pos_slot = getelementptr i64, i64* %acw_arr, i64 %pos_i64\n\
         \x20 store i64 %w_sc_v, i64* %acw_pos_slot\n\
         \x20 br label %bc_scatter_next\n\
         bc_scatter_next:\n\
         \x20 %ce_inc = add i64 %ce, 1\n\
         \x20 store i64 %ce_inc, i64* %sp_e\n\
         \x20 br label %bc_scatter_loop\n\
         bc_finish:\n\
         \x20 %cur_free = bitcast i32* %cur_arr to i8*\n\
         ...
         \x20 br i1 %bad, label %bfs_zero, label %bfs_build\n\
         bfs_zero:\n\
         \x20 ret i64 0\n\
         bfs_build:\n\
         ...
         \x20 %as_arr_bfs = load i32*, i32** %asp\n\
         \x20 %k0_slot = getelementptr i32, i32* %as_arr_bfs, i64 %u\n\
         \x20 %k0_i32 = load i32, i32* %k0_slot\n\
         \x20 %u_p1_bfs = add i64 %u, 1\n\
         \x20 %k1_slot = getelementptr i32, i32* %as_arr_bfs, i64 %u_p1_bfs\n\
         \x20 %k1_i32 = load i32, i32* %k1_slot\n\
         \x20 %k0_i64 = sext i32 %k0_i32 to i64\n\
         \x20 %k1_i64 = sext i32 %k1_i32 to i64\n\
         \x20 %k_p = alloca i64\n\
         \x20 store i64 %k0_i64, i64* %k_p\n\
         \x20 br label %bfs_nbr_loop\n\
         bfs_nbr_loop:\n\
         \x20 %k = load i64, i64* %k_p\n\
         \x20 %k_done = icmp sge i64 %k, %k1_i64\n\
         \x20 br i1 %k_done, label %bfs_outer, label %bfs_nbr_body\n\
         bfs_nbr_body:\n\
         \x20 %acd_arr_bfs = load i32*, i32** %acdp\n\
         \x20 %acd_slot = getelementptr i32, i32* %acd_arr_bfs, i64 %k\n\
         \x20 %dst32_bfs = load i32, i32* %acd_slot\n\
         \x20 %v_bfs = sext i32 %dst32_bfs to i64\n\
         \x20 %v_lo = icmp slt i64 %v_bfs, 0\n\
         \x20 %v_hi = icmp sge i64 %v_bfs, %nn\n\
         \x20 %v_bad = or i1 %v_lo, %v_hi\n\
         \x20 br i1 %v_bad, label %bfs_nbr_next, label %bfs_nbr_visit\n\
         bfs_nbr_visit:\n\
         \x20 %vv_slot = getelementptr i8, i8* %visited, i64 %v_bfs\n\
         \x20 %was = load i8, i8* %vv_slot\n\
         \x20 %seen = icmp ne i8 %was, 0\n\
         \x20 br i1 %seen, label %bfs_nbr_next, label %bfs_nbr_push\n\
         bfs_nbr_push:\n\
         \x20 store i8 1, i8* %vv_slot\n\
         \x20 %qt_cur = load i64, i64* %qt_p\n\
         \x20 %q_new_slot = getelementptr i64, i64* %queue, i64 %qt_cur\n\
         \x20 store i64 %v_bfs, i64* %q_new_slot\n\
         ...
         \x20 br label %bfs_nbr_next\n\
         bfs_nbr_next:\n\
         \x20 %k_inc_bfs = add i64 %k, 1\n\
         \x20 store i64 %k_inc_bfs, i64* %k_p\n\
         \x20 br label %bfs_nbr_loop\n\
         bfs_finish:\n\
         ...
         ; Closure #336: DFS via CSR — O(V+E) instead of O(V*E).\n\
         ...
         \x20 %bad1 = or i1 %nn_zero, %start_lo\n\
         \x20 %bad = or i1 %bad1, %start_hi\n\
         \x20 br i1 %bad, label %dfs_zero, label %dfs_build\n\
         dfs_zero:\n\
         \x20 ret i64 0\n\
         dfs_build:\n\
         \x20 call void @intent_graph_build_csr_if_needed(%intent_graph* %g)\n\
         ...
         \x20 %u = load i64, i64* %u_slot\n\
         \x20 %as_arr_dfs = load i32*, i32** %asp\n\
         \x20 %dk0_slot = getelementptr i32, i32* %as_arr_dfs, i64 %u\n\
         \x20 %dk0_i32 = load i32, i32* %dk0_slot\n\
         \x20 %u_p1_dfs = add i64 %u, 1\n\
         \x20 %dk1_slot = getelementptr i32, i32* %as_arr_dfs, i64 %u_p1_dfs\n\
         \x20 %dk1_i32 = load i32, i32* %dk1_slot\n\
         \x20 %dk0_i64 = sext i32 %dk0_i32 to i64\n\
         \x20 %dk1_i64 = sext i32 %dk1_i32 to i64\n\
         \x20 %dk_p = alloca i64\n\
         \x20 store i64 %dk0_i64, i64* %dk_p\n\
         \x20 br label %dfs_nbr_loop\n\
         dfs_nbr_loop:\n\
         \x20 %dk = load i64, i64* %dk_p\n\
         \x20 %dk_done = icmp sge i64 %dk, %dk1_i64\n\
         \x20 br i1 %dk_done, label %dfs_outer, label %dfs_nbr_body\n\
         dfs_nbr_body:\n\
         \x20 %acd_arr_dfs = load i32*, i32** %acdp\n\
         \x20 %dacd_slot = getelementptr i32, i32* %acd_arr_dfs, i64 %dk\n\
         \x20 %ddst32 = load i32, i32* %dacd_slot\n\
         \x20 %dv = sext i32 %ddst32 to i64\n\
         \x20 %dv_lo = icmp slt i64 %dv, 0\n\
         \x20 %dv_hi = icmp sge i64 %dv, %nn\n\
         \x20 %dv_bad = or i1 %dv_lo, %dv_hi\n\
         \x20 br i1 %dv_bad, label %dfs_nbr_next, label %dfs_nbr_visit\n\
         dfs_nbr_visit:\n\
         \x20 %dvv_slot = getelementptr i8, i8* %visited, i64 %dv\n\
         \x20 %dwas = load i8, i8* %dvv_slot\n\
         \x20 %dseen = icmp ne i8 %dwas, 0\n\
         \x20 br i1 %dseen, label %dfs_nbr_next, label %dfs_nbr_push\n\
         dfs_nbr_push:\n\
         \x20 store i8 1, i8* %dvv_slot\n\
         \x20 %dsp_cur = load i64, i64* %sp_p\n\
         \x20 %ds_new_slot = getelementptr i64, i64* %stack, i64 %dsp_cur\n\
         \x20 store i64 %dv, i64* %ds_new_slot\n\
         \x20 %dsp_inc = add i64 %dsp_cur, 1\n\
         \x20 store i64 %dsp_inc, i64* %sp_p\n\
         \x20 %dcnt = load i64, i64* %count_p\n\
         \x20 %dcnt_inc = add i64 %dcnt, 1\n\
         \x20 store i64 %dcnt_inc, i64* %count_p\n\
         \x20 br label %dfs_nbr_next\n\
         dfs_nbr_next:\n\
         \x20 %dk_inc = add i64 %dk, 1\n\
         \x20 store i64 %dk_inc, i64* %dk_p\n\
         \x20 br label %dfs_nbr_loop\n\
         dfs_finish:\n\
         \x20 call void @free(i8* %visited)\n\
         ...
         ; Closure #333 + #337: has_cycle via CSR (O(V+E)).\n\
         define i1 @intent_graph_has_cycle(%intent_graph* %g) {\n\
         \x20 %nnp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 0\n\
         \x20 %nn = load i64, i64* %nnp\n\
         \x20 %nn_zero = icmp sle i64 %nn, 0\n\
         \x20 br i1 %nn_zero, label %hc_false, label %hc_build\n\
         hc_build:\n\
         \x20 call void @intent_graph_build_csr_if_needed(%intent_graph* %g)\n\
         \x20 %asp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 6\n\
         \x20 %acdp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 7\n\
         ...
         \x20 %queue_i8 = call i8* @malloc(i64 %q_bytes)\n\
         \x20 %queue = bitcast i8* %queue_i8 to i64*\n\
         \x20 ; Count in-degrees via CSR: for each source s, iterate adj_start[s]..adj_start[s+1].\n\
         \x20 %s_p = alloca i64\n\
         \x20 store i64 0, i64* %s_p\n\
         \x20 br label %hc_src_loop\n\
         hc_src_loop:\n\
         \x20 %s = load i64, i64* %s_p\n\
         \x20 %s_done = icmp sge i64 %s, %nn\n\
         \x20 br i1 %s_done, label %hc_seed_init, label %hc_src_body\n\
         hc_src_body:\n\
         \x20 %as_arr_c = load i32*, i32** %asp\n\
         \x20 %k0_slot_c = getelementptr i32, i32* %as_arr_c, i64 %s\n\
         \x20 %k0_i32_c = load i32, i32* %k0_slot_c\n\
         \x20 %s_p1 = add i64 %s, 1\n\
         \x20 %k1_slot_c = getelementptr i32, i32* %as_arr_c, i64 %s_p1\n\
         \x20 %k1_i32_c = load i32, i32* %k1_slot_c\n\
         \x20 %k0_i64_c = sext i32 %k0_i32_c to i64\n\
         \x20 %k1_i64_c = sext i32 %k1_i32_c to i64\n\
         \x20 %k_p_c = alloca i64\n\
         \x20 store i64 %k0_i64_c, i64* %k_p_c\n\
         \x20 br label %hc_count_loop\n\
         hc_count_loop:\n\
         \x20 %k_c = load i64, i64* %k_p_c\n\
         \x20 %k_done_c = icmp sge i64 %k_c, %k1_i64_c\n\
         \x20 br i1 %k_done_c, label %hc_src_next, label %hc_count_body\n\
         hc_count_body:\n\
         \x20 %acd_arr_c = load i32*, i32** %acdp\n\
         \x20 %v_slot_c = getelementptr i32, i32* %acd_arr_c, i64 %k_c\n\
         \x20 %v32_c = load i32, i32* %v_slot_c\n\
         \x20 %v_c = sext i32 %v32_c to i64\n\
         \x20 %v_lo_c = icmp slt i64 %v_c, 0\n\
         \x20 %v_hi_c = icmp sge i64 %v_c, %nn\n\
         \x20 %v_bad_c = or i1 %v_lo_c, %v_hi_c\n\
         \x20 br i1 %v_bad_c, label %hc_count_next, label %hc_count_incr\n\
         hc_count_incr:\n\
         \x20 %ind_slot = getelementptr i64, i64* %in_deg, i64 %v_c\n\
         \x20 %ind_v = load i64, i64* %ind_slot\n\
         \x20 %ind_v_inc = add i64 %ind_v, 1\n\
         \x20 store i64 %ind_v_inc, i64* %ind_slot\n\
         \x20 br label %hc_count_next\n\
         hc_count_next:\n\
         \x20 %k_inc_c = add i64 %k_c, 1\n\
         \x20 store i64 %k_inc_c, i64* %k_p_c\n\
         \x20 br label %hc_count_loop\n\
         hc_src_next:\n\
         \x20 %s_inc = add i64 %s, 1\n\
         \x20 store i64 %s_inc, i64* %s_p\n\
         \x20 br label %hc_src_loop\n\
         hc_seed_init:\n\
         \x20 %qh_p = alloca i64\n\
         \x20 %qt_p = alloca i64\n\
         ...
         \x20 %as_arr_p = load i32*, i32** %asp\n\
         \x20 %uk0_slot = getelementptr i32, i32* %as_arr_p, i64 %u\n\
         \x20 %uk0_i32 = load i32, i32* %uk0_slot\n\
         \x20 %u_p1 = add i64 %u, 1\n\
         \x20 %uk1_slot = getelementptr i32, i32* %as_arr_p, i64 %u_p1\n\
         \x20 %uk1_i32 = load i32, i32* %uk1_slot\n\
         \x20 %uk0_i64 = sext i32 %uk0_i32 to i64\n\
         \x20 %uk1_i64 = sext i32 %uk1_i32 to i64\n\
         \x20 %nk_p = alloca i64\n\
         \x20 store i64 %uk0_i64, i64* %nk_p\n\
         \x20 br label %hc_nbr_loop\n\
         hc_nbr_loop:\n\
         \x20 %nk = load i64, i64* %nk_p\n\
         \x20 %nk_done = icmp sge i64 %nk, %uk1_i64\n\
         \x20 br i1 %nk_done, label %hc_outer, label %hc_nbr_body\n\
         hc_nbr_body:\n\
         \x20 %acd_arr_p = load i32*, i32** %acdp\n\
         \x20 %v_slot_p = getelementptr i32, i32* %acd_arr_p, i64 %nk\n\
         \x20 %v32_p = load i32, i32* %v_slot_p\n\
         \x20 %v_p = sext i32 %v32_p to i64\n\
         \x20 %v_lo_p = icmp slt i64 %v_p, 0\n\
         \x20 %v_hi_p = icmp sge i64 %v_p, %nn\n\
         \x20 %v_bad_p = or i1 %v_lo_p, %v_hi_p\n\
         \x20 br i1 %v_bad_p, label %hc_nbr_next, label %hc_nbr_dec\n\
         hc_nbr_dec:\n\
         \x20 %vd_slot = getelementptr i64, i64* %in_deg, i64 %v_p\n\
         \x20 %vd_v = load i64, i64* %vd_slot\n\
         \x20 %vd_dec = sub i64 %vd_v, 1\n\
         \x20 store i64 %vd_dec, i64* %vd_slot\n\
         \x20 %vd_zero = icmp eq i64 %vd_dec, 0\n\
         \x20 br i1 %vd_zero, label %hc_nbr_push, label %hc_nbr_next\n\
         hc_nbr_push:\n\
         \x20 %qt_cur_p = load i64, i64* %qt_p\n\
         \x20 %q_push_p = getelementptr i64, i64* %queue, i64 %qt_cur_p\n\
         \x20 store i64 %v_p, i64* %q_push_p\n\
         \x20 %qt_inc_p = add i64 %qt_cur_p, 1\n\
         \x20 store i64 %qt_inc_p, i64* %qt_p\n\
         \x20 br label %hc_nbr_next\n\
         hc_nbr_next:\n\
         \x20 %nk_inc = add i64 %nk, 1\n\
         \x20 store i64 %nk_inc, i64* %nk_p\n\
         \x20 br label %hc_nbr_loop\n\
         hc_finish:\n\
    ...
    if emit_vec_dep {
        out.push_str(
            "; Closure #335 + #337: topological sort via CSR (O(V+E)).\n\
         define i64 @intent_graph_topo_sort(%intent_graph* %g, %intent_vec_i64* %out) {\n\
         \x20 %nnp = getelementptr %intent_graph, %intent_graph* %g, i32 0, i32 0\n\
         \x20 %nn = load i64, i64* %nnp\n\
         \x20 %nn_zero = icmp sle i64 %nn, 0\n\
         \x20 br i1 %nn_zero, label %ts_zero, label %ts_build\n\
         ts_zero:\n\
         \x20 ret i64 0\n\
         ts_build:\n\
         \x20 call void @intent_graph_build_csr_if_needed(%intent_graph* %g)\n\
         ...
         \x20 %queue_i8 = call i8* @malloc(i64 %q_bytes)\n\
         \x20 %queue = bitcast i8* %queue_i8 to i64*\n\
         \x20 ; Count in-degrees by walking CSR neighbor lists.\n\
         \x20 %s_p_ts = alloca i64\n\
         \x20 store i64 0, i64* %s_p_ts\n\
         \x20 br label %ts_src_loop\n\
         ts_src_loop:\n\
         \x20 %s_ts = load i64, i64* %s_p_ts\n\
         \x20 %s_done_ts = icmp sge i64 %s_ts, %nn\n\
         \x20 br i1 %s_done_ts, label %ts_grow_decide, label %ts_src_body\n\
         ts_src_body:\n\
         \x20 %as_arr_count = load i32*, i32** %asp\n\
         \x20 %ts_k0_slot = getelementptr i32, i32* %as_arr_count, i64 %s_ts\n\
         \x20 %ts_k0_i32 = load i32, i32* %ts_k0_slot\n\
         \x20 %s_ts_p1 = add i64 %s_ts, 1\n\
         \x20 %ts_k1_slot = getelementptr i32, i32* %as_arr_count, i64 %s_ts_p1\n\
         \x20 %ts_k1_i32 = load i32, i32* %ts_k1_slot\n\
         \x20 %ts_k0_i64 = sext i32 %ts_k0_i32 to i64\n\
         \x20 %ts_k1_i64 = sext i32 %ts_k1_i32 to i64\n\
         \x20 %ts_k_p_count = alloca i64\n\
         \x20 store i64 %ts_k0_i64, i64* %ts_k_p_count\n\
         \x20 br label %ts_count_loop\n\
         ts_count_loop:\n\
         \x20 %ts_k_count = load i64, i64* %ts_k_p_count\n\
         \x20 %ts_k_done_count = icmp sge i64 %ts_k_count, %ts_k1_i64\n\
         \x20 br i1 %ts_k_done_count, label %ts_src_next, label %ts_count_body\n\
         ts_count_body:\n\
         \x20 %acd_arr_count = load i32*, i32** %acdp\n\
         \x20 %ts_v_slot_count = getelementptr i32, i32* %acd_arr_count, i64 %ts_k_count\n\
         \x20 %ts_v32_count = load i32, i32* %ts_v_slot_count\n\
         \x20 %ts_v_count = sext i32 %ts_v32_count to i64\n\
         \x20 %ts_v_lo_count = icmp slt i64 %ts_v_count, 0\n\
         \x20 %ts_v_hi_count = icmp sge i64 %ts_v_count, %nn\n\
         \x20 %ts_v_bad_count = or i1 %ts_v_lo_count, %ts_v_hi_count\n\
         \x20 br i1 %ts_v_bad_count, label %ts_count_next, label %ts_count_incr\n\
         ts_count_incr:\n\
         \x20 %ts_ind_slot = getelementptr i64, i64* %in_deg, i64 %ts_v_count\n\
         \x20 %ts_ind_v = load i64, i64* %ts_ind_slot\n\
         \x20 %ts_ind_v_inc = add i64 %ts_ind_v, 1\n\
         \x20 store i64 %ts_ind_v_inc, i64* %ts_ind_slot\n\
         \x20 br label %ts_count_next\n\
         ts_count_next:\n\
         \x20 %ts_k_inc_count = add i64 %ts_k_count, 1\n\
         \x20 store i64 %ts_k_inc_count, i64* %ts_k_p_count\n\
         \x20 br label %ts_count_loop\n\
         ts_src_next:\n\
         \x20 %s_inc_ts = add i64 %s_ts, 1\n\
         \x20 store i64 %s_inc_ts, i64* %s_p_ts\n\
         \x20 br label %ts_src_loop\n\
         ts_grow_decide:\n\
         ...
         \x20 store i64 %proc_inc, i64* %proc_p\n\
         \x20 ; Walk u_ts's CSR neighbors.\n\
         \x20 %as_arr_pop_ts = load i32*, i32** %asp\n\
         \x20 %ts_uk0_slot = getelementptr i32, i32* %as_arr_pop_ts, i64 %u_ts\n\
         \x20 %ts_uk0_i32 = load i32, i32* %ts_uk0_slot\n\
         \x20 %u_ts_p1 = add i64 %u_ts, 1\n\
         \x20 %ts_uk1_slot = getelementptr i32, i32* %as_arr_pop_ts, i64 %u_ts_p1\n\
         \x20 %ts_uk1_i32 = load i32, i32* %ts_uk1_slot\n\
         \x20 %ts_uk0_i64 = sext i32 %ts_uk0_i32 to i64\n\
         \x20 %ts_uk1_i64 = sext i32 %ts_uk1_i32 to i64\n\
         \x20 %ts_nk_p = alloca i64\n\
         \x20 store i64 %ts_uk0_i64, i64* %ts_nk_p\n\
         \x20 br label %ts_nbr_loop\n\
         ts_nbr_loop:\n\
         \x20 %ts_nk = load i64, i64* %ts_nk_p\n\
         \x20 %ts_nk_done = icmp sge i64 %ts_nk, %ts_uk1_i64\n\
         \x20 br i1 %ts_nk_done, label %ts_outer, label %ts_nbr_body\n\
         ts_nbr_body:\n\
         \x20 %acd_arr_pop_ts = load i32*, i32** %acdp\n\
         \x20 %ts_v_slot = getelementptr i32, i32* %acd_arr_pop_ts, i64 %ts_nk\n\
         \x20 %ts_v32 = load i32, i32* %ts_v_slot\n\
         \x20 %ts_v = sext i32 %ts_v32 to i64\n\
         \x20 %ts_v_lo = icmp slt i64 %ts_v, 0\n\
         \x20 %ts_v_hi = icmp sge i64 %ts_v, %nn\n\
         \x20 %ts_v_bad = or i1 %ts_v_lo, %ts_v_hi\n\
         \x20 br i1 %ts_v_bad, label %ts_nbr_next, label %ts_nbr_dec\n\
         ts_nbr_dec:\n\
         \x20 %ts_vd_slot = getelementptr i64, i64* %in_deg, i64 %ts_v\n\
         \x20 %ts_vd_v = load i64, i64* %ts_vd_slot\n\
         \x20 %ts_vd_dec = sub i64 %ts_vd_v, 1\n\
         \x20 store i64 %ts_vd_dec, i64* %ts_vd_slot\n\
         \x20 %ts_vd_zero = icmp eq i64 %ts_vd_dec, 0\n\
         \x20 br i1 %ts_vd_zero, label %ts_nbr_push, label %ts_nbr_next\n\
         ts_nbr_push:\n\
         \x20 %qt_cur_nbr = load i64, i64* %qt_p\n\
         \x20 %q_push_nbr = getelementptr i64, i64* %queue, i64 %qt_cur_nbr\n\
         \x20 store i64 %ts_v, i64* %q_push_nbr\n\
         \x20 %qt_inc_nbr = add i64 %qt_cur_nbr, 1\n\
         \x20 store i64 %qt_inc_nbr, i64* %qt_p\n\
         \x20 br label %ts_nbr_next\n\
         ts_nbr_next:\n\
         \x20 %ts_nk_inc = add i64 %ts_nk, 1\n\
         \x20 store i64 %ts_nk_inc, i64* %ts_nk_p\n\
         \x20 br label %ts_nbr_loop\n\
         ts_finish:\n\
    ...
    if has_option_i64 {
        out.push_str(
            "; Closure #329 + #337: Dijkstra now relaxes via CSR.\n\
             ...
             \x20 br i1 %same, label %dj_zero, label %dj_build\n\
             dj_zero:\n\
             ...
             dj_relax_init:\n\
             \x20 ; Walk u's CSR neighbors.\n\
             \x20 %dj_as_arr = load i32*, i32** %asp\n\
             \x20 %dj_uk0_slot = getelementptr i32, i32* %dj_as_arr, i64 %u\n\
             \x20 %dj_uk0_i32 = load i32, i32* %dj_uk0_slot\n\
             \x20 %dj_u_p1 = add i64 %u, 1\n\
             \x20 %dj_uk1_slot = getelementptr i32, i32* %dj_as_arr, i64 %dj_u_p1\n\
             \x20 %dj_uk1_i32 = load i32, i32* %dj_uk1_slot\n\
             \x20 %dj_uk0_i64 = sext i32 %dj_uk0_i32 to i64\n\
             \x20 %dj_uk1_i64 = sext i32 %dj_uk1_i32 to i64\n\
             \x20 %dj_k_p = alloca i64\n\
             \x20 store i64 %dj_uk0_i64, i64* %dj_k_p\n\
             \x20 br label %dj_relax_loop\n\
             dj_relax_loop:\n\
             \x20 %dj_k = load i64, i64* %dj_k_p\n\
             \x20 %dj_k_done = icmp sge i64 %dj_k, %dj_uk1_i64\n\
             \x20 br i1 %dj_k_done, label %dj_outer_inc, label %dj_relax_body\n\
             dj_relax_body:\n\
             \x20 %dj_acd_arr = load i32*, i32** %acdp\n\
             \x20 %dj_v_slot = getelementptr i32, i32* %dj_acd_arr, i64 %dj_k\n\
             \x20 %dj_v32 = load i32, i32* %dj_v_slot\n\
             \x20 %v = sext i32 %dj_v32 to i64\n\
             \x20 %v_lo = icmp slt i64 %v, 0\n\
             \x20 %v_hi = icmp sge i64 %v, %nn\n\
             \x20 %v_bad = or i1 %v_lo, %v_hi\n\
             \x20 br i1 %v_bad, label %dj_relax_next, label %dj_relax_inner\n\
             dj_relax_inner:\n\
             \x20 %dj_acw_arr = load i64*, i64** %acwp\n\
             \x20 %dj_w_slot = getelementptr i64, i64* %dj_acw_arr, i64 %dj_k\n\
             \x20 %w_v = load i64, i64* %dj_w_slot\n\
             ...
             dj_relax_next:\n\
             \x20 %dj_k_inc = add i64 %dj_k, 1\n\
             \x20 store i64 %dj_k_inc, i64* %dj_k_p\n\
             \x20 br label %dj_relax_loop\n\
             dj_outer_inc:\n\
        ...
        if emit_vec_dep {
            out.push_str(
                "; Closure #334 + #337: A* now relaxes via CSR.\n\
             ...
             \x20 br i1 %same_as, label %as_zero, label %as_build\n\
             as_zero:\n\
             ...
             \x20 ; Walk u_as's CSR neighbors.\n\
             \x20 %as_as_arr = load i32*, i32** %asp\n\
             \x20 %as_uk0_slot = getelementptr i32, i32* %as_as_arr, i64 %u_as\n\
             \x20 %as_uk0_i32 = load i32, i32* %as_uk0_slot\n\
             \x20 %as_u_p1 = add i64 %u_as, 1\n\
             \x20 %as_uk1_slot = getelementptr i32, i32* %as_as_arr, i64 %as_u_p1\n\
             \x20 %as_uk1_i32 = load i32, i32* %as_uk1_slot\n\
             \x20 %as_uk0_i64 = sext i32 %as_uk0_i32 to i64\n\
             \x20 %as_uk1_i64 = sext i32 %as_uk1_i32 to i64\n\
             \x20 %as_k_p = alloca i64\n\
             \x20 store i64 %as_uk0_i64, i64* %as_k_p\n\
             \x20 br label %as_relax_loop\n\
             as_relax_loop:\n\
             \x20 %as_k = load i64, i64* %as_k_p\n\
             \x20 %as_k_done = icmp sge i64 %as_k, %as_uk1_i64\n\
             \x20 br i1 %as_k_done, label %as_iter_inc, label %as_relax_body\n\
             as_relax_body:\n\
             \x20 %as_acd_arr = load i32*, i32** %acdp\n\
             \x20 %as_v_slot = getelementptr i32, i32* %as_acd_arr, i64 %as_k\n\
             \x20 %as_v32 = load i32, i32* %as_v_slot\n\
             \x20 %v_as = sext i32 %as_v32 to i64\n\
             ...
             as_relax_inner:\n\
             \x20 %as_acw_arr = load i64*, i64** %acwp\n\
             \x20 %as_w_slot = getelementptr i64, i64* %as_acw_arr, i64 %as_k\n\
             \x20 %w_v_as = load i64, i64* %as_w_slot\n\
             ...
             as_relax_next:\n\
             \x20 %as_k_inc = add i64 %as_k, 1\n\
             \x20 store i64 %as_k_inc, i64* %as_k_p\n\
             \x20 br label %as_relax_loop\n\
             as_iter_inc:\n\
...
fn emit_intent_skiplist_i64_helpers_llvm(out: &mut String, has_option_i64: bool) {
    out.push_str(
        "define i64 @intent_skiplist_i64_rand(%intent_skiplist_i64* %sl) {\n\
         ...
         \x20 %r7 = insertvalue %intent_skiplist_i64 %r6, i64 -1, 7\n\
         \x20 store %intent_skiplist_i64 %r7, %intent_skiplist_i64* %sl_alloca\n\
         ...
         \x20 %tnp_d = getelementptr %intent_skiplist_i64, %intent_skiplist_i64* %sl, i32 0, i32 7\n\
         \x20 store i64 0, i64* %nnp\n\
         \x20 store i64 0, i64* %capp\n\
         \x20 store i64 0, i64* %nkp\n\
         \x20 store i64 -1, i64* %tnp_d\n\
         \x20 ret void\n\
         }\n\
         ...
         \x20 br label %si_clear_loop\n\
         si_finish:\n\
         \x20 ; Closure #341 tail tracker: if new node's level-0 forward\n\
         \x20 ; is -1, it's the new rightmost node.\n\
         \x20 %fwd_tc = load i32*, i32** %fp\n\
         \x20 %new_base_tc = mul i64 %new_idx, 8\n\
         \x20 %new_l0_slot = getelementptr i32, i32* %fwd_tc, i64 %new_base_tc\n\
         \x20 %new_l0 = load i32, i32* %new_l0_slot\n\
         \x20 %new_is_tail = icmp eq i32 %new_l0, -1\n\
         \x20 br i1 %new_is_tail, label %si_set_tail, label %si_after_tail\n\
         si_set_tail:\n\
         \x20 %tnp_si = getelementptr %intent_skiplist_i64, %intent_skiplist_i64* %sl, i32 0, i32 7\n\
         \x20 store i64 %new_idx, i64* %tnp_si\n\
         \x20 br label %si_after_tail\n\
         si_after_tail:\n\
         ...
         \x20 ; new tail is update[0]. If update[0] is the head (idx 0)\n\
         \x20 ; the list is now empty (tail = -1).\n\
         \x20 %tnp_rm = getelementptr %intent_skiplist_i64, %intent_skiplist_i64* %sl, i32 0, i32 7\n\
         \x20 %tn_cur_rm = load i64, i64* %tnp_rm\n\
         \x20 %cand64_check = sext i32 %cand_rm to i64\n\
         \x20 %was_tail = icmp eq i64 %cand64_check, %tn_cur_rm\n\
         \x20 br i1 %was_tail, label %srm_update_tail, label %srm_decr\n\
         srm_update_tail:\n\
         \x20 %upd0_tail_slot = getelementptr [8 x i32], [8 x i32]* %update, i64 0, i64 0\n\
         \x20 %upd0_tail_i32 = load i32, i32* %upd0_tail_slot\n\
         \x20 %upd0_is_head = icmp eq i32 %upd0_tail_i32, 0\n\
         \x20 %upd0_tail_i64 = sext i32 %upd0_tail_i32 to i64\n\
         \x20 %new_tail = select i1 %upd0_is_head, i64 -1, i64 %upd0_tail_i64\n\
         \x20 store i64 %new_tail, i64* %tnp_rm\n\
         \x20 br label %srm_decr\n\
         srm_decr:\n\
    ...
    if has_option_i64 {
        out.push_str(
            "define %Enum_Option__i64 @intent_skiplist_i64_min(%intent_skiplist_i64* %sl) {\n\
             ...
             \x20 %kp_mx = getelementptr %intent_skiplist_i64, %intent_skiplist_i64* %sl, i32 0, i32 0\n\
             \x20 %tnp_mx = getelementptr %intent_skiplist_i64, %intent_skiplist_i64* %sl, i32 0, i32 7\n\
             \x20 %tn_mx = load i64, i64* %tnp_mx\n\
             \x20 %tn_none = icmp eq i64 %tn_mx, -1\n\
             \x20 br i1 %tn_none, label %smx_none, label %smx_some\n\
             smx_some:\n\
             \x20 %keys_mx = load i64*, i64** %kp_mx\n\
             \x20 %k_slot_mx = getelementptr i64, i64* %keys_mx, i64 %tn_mx\n\
             \x20 %k_mx = load i64, i64* %k_slot_mx\n\
             \x20 %s0 = insertvalue %Enum_Option__i64 undef, i32 0, 0\n\
             \x20 %s1 = insertvalue %Enum_Option__i64 %s0, i64 %k_mx, 1\n\
             \x20 ret %Enum_Option__i64 %s1\n\
             smx_none:\n\
             \x20 %n0 = insertvalue %Enum_Option__i64 undef, i32 1, 0\n\
             \x20 %n1 = insertvalue %Enum_Option__i64 %n0, i64 0, 1\n\
