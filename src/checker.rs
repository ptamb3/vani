...
fn check_option_i64_builtin(
    ...
    let ret_ty = match name {
        ...
        "option_map" => Type::Enum(mangle_generic_decl("Option", &[Type::I64])),
        _ => Type::Bool,
    };
    if args.len() != want_args {
        diagnostics.push(Diagnostic::new(
