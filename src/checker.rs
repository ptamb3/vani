...
fn check_math_builtin(
    ...
    let want_args = match name {
        ...
        | "i64_rotate_left" | "i64_rotate_right" => 2,
    ...
    // Closures #401 + #402: i64-only bit-manipulation primitives.
    if matches!(
        name,
