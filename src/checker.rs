    ...
    if name == "hash_combine_3" {
        for (i, a) in args.iter().enumerate() {
            ...
            let coerced = coerce_checked(
                ...
                &Type::U64,
                a.span,
                &format!("hash_combine_3 argument {}", i),
                diagnostics,
            );
            typed_args.push(coerced.expr);
        }
