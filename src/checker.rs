...
fn check_math_builtin(
    ...
    let want_args = match name {
        ...
        | "i64_div_floor" | "i64_mod_floor" => 2,
        // Closure #406: f64_lerp takes 3 args. Handled before
        // the dispatch generic loop below by an explicit
        // 3-arg branch matching the F64 coerce path.
        "f64_lerp" => 3,
        "f64_pi" | "f64_e" | "f64_inf" | "f64_nan"
    ...
    // Closures #401 + #402 + #405 + #408 + #409: i64-only bit /
    // floor / log / power-of-2 primitives.
    if matches!(
        name,
