...
fn check_math_builtin(
    ...
    // Closures #401 + #402 + #405 + #408 + #409 + #410: i64-only
    // bit / floor / log / pow2 / saturating primitives.
    if matches!(
        name,
