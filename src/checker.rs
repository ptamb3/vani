...
fn check_vec_utility_builtin(
    ...
    let want_args = match name {
        ...
        | "vec_cumulative_max" | "vec_cumulative_min"
        | "vec_running_product" | "vec_running_xor"
        | "vec_running_and" | "vec_running_or" => 1,
        _ => 2,
    };
    if args.len() != want_args {
        diagnostics.push(Diagnostic::new(
    ...
    if matches!(name, "vec_reverse_copy" | "vec_unique" | "vec_running_sum" | "vec_cumulative_max" | "vec_cumulative_min" | "vec_running_product" | "vec_running_xor" | "vec_running_and" | "vec_running_or") {
        let ok = matches!(
            a0_raw.ty(),
