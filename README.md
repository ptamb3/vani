...
| **2 — Generic containers** (deps: Level 1, generic decls #281) | ✅ BinaryHeap-on-Vec (#302) · ✅ `Deque<i64>` (#303) · ✅ `HashSet<i64>` (#304) · ✅ `HashMap<i64, i64>` (#305, AFFINE under Copy-V; AFFINE-TENSION queued for non-Copy V). ⏳ `BTreeSet<T>`, `BTreeMap<K, V>`, dedicated `BinaryHeap<T>` wrapper type | ✅ / ⚠️ AFFINE-TENSION |
