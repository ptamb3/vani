...
| Closures w/ captures | `let f = fn(x) -> R { ...captured_n... }; f(...)` — capture-by-value of Copy outer bindings; callable in same fn only (closure #314) | ✅ AFFINE under v1 Copy contract |
